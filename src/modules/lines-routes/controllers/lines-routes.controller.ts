...
export class LinesRoutesController {
  ...
  async findNearestLinesRoutes(
    @Body() nearestLinesRoutesDto: NearestLinesRoutesDto,
  ) {
    return await this.linesRoutesService.findNearestLinesRoutes(
      nearestLinesRoutesDto,
    );
  }
}
